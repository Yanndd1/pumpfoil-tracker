...
const DashboardPage: React.FC = () => {
  ...
  const handleSync = async () => {
    ...
    if (count > 0) {
      ...
      console.log(`${count} nouvelles sessions importées`);
    }
  };
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="text-gray-500 mt-1">
              Suivez vos progrès en pumpfoil
            </p>
          </div>
          <button
            onClick={handleSync}
        ...
        {sessions.length === 0 ? (
          <EmptyState
            ...
            description="Synchronisez vos activités Strava pour commencer à tracker vos progrès en pumpfoil."
            action={
              <button
                onClick={handleSync}
                disabled={isSyncing}
            ...
            {progressStats && (
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <StatCard
                  ...
                  subtitle={`${progressStats.averageRunsPerSession.toFixed(1)} par session`}
                  icon={<Zap className="h-5 w-5 text-ocean-600" />}
                />
                <StatCard
                  title="Durée moy. par tour"
            ...
            {sessions.length >= 3 && (
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <ProgressChart
                  sessions={sessions}
                  metric="distance"
                  title="Progression de la distance"
                />
              </div>
            )}
